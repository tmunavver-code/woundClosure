%% runSaturdayUrvi: Force-Based Transitions — Comprehensive Results
%
...
%   results/saturday_urvi_2026-08-15/
%
% Key outputs:
...
fprintf(fid, 'Force-Based Transitions Run — saturday_urvi_2026-08-15\n');
fprintf(fid, '==========================================================\n');
fprintf(fid, 'Date: %s\n', datestr(now));
fprintf(fid, 'Case: %s\n', Case);
fprintf(fid, 'p0 = %.2f\n', param.p0);
